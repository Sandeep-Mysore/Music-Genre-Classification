...
def learn_and_classify(X_train, y_train, X_test, y_test, genre_list):
    ...
    joblib.dump(logistic_classifier, 'models/model_fft_log.pkl')
    ...
    print("knn_cm:")
    print(knn_cm)
    joblib.dump(knn_classifier, 'models/model_fft_knn.pkl')
    ...
    plot_confusion_matrix(logistic_cm, "Confusion matrix for log reg", genre_list)
